...
class DisplayMembers: UITableViewController{
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = self.userList[indexPath.row]//self.classNames[indexPath.row] <- text on the cell
        print("making celll")
        return cell
    }
